...
public class BLECentralPlugin extends CordovaPlugin {
    ...
    private void addStateListener() {
        ...
        try {
            ...
            webView.getContext().registerReceiver(this.stateReceiver, intentFilter, android.content.Context.RECEIVER_NOT_EXPORTED);
        } catch (Exception e) {
    ...
    private void addLocationStateListener() {
        ...
        try {
            ...
            webView.getContext().registerReceiver(this.locationStateReceiver, intentFilter, android.content.Context.RECEIVER_NOT_EXPORTED);
        } catch (Exception e) {
    ...
    private void setPin(CallbackContext callbackContext, final String pin) {
        ...
        try {
            ...
            webView.getContext().registerReceiver(broadCastReceiver, intentFilter, android.content.Context.RECEIVER_NOT_EXPORTED);
    ...
    private void addBondStateListener() {
        if (bondStateReceiver == null) {
            ...
            webView.getContext().registerReceiver(bondStateReceiver, new IntentFilter(ACTION_BOND_STATE_CHANGED), android.content.Context.RECEIVER_NOT_EXPORTED);
        }
    }
